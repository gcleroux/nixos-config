{ pkgs, ... }: {
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      dpon = ''
        hyprctl keyword monitor "eDP-1, preferred, 0x0, 1.566666";
        hyprctl keyword monitor "DP-3, disable"; 
        hyprctl keyword monitor "DP-4, disable"
      '';
      dpoff = ''
        hyprctl keyword monitor "DP-4,preferred,0x0,1.666667";
        hyprctl keyword monitor "DP-3,preferred,2304x0,1.666667";
